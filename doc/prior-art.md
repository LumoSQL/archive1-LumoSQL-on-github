...
| [Sleepycat/Oracle BDB](https://github.com/hyc/BerkeleyDB) | current(?) | Disusedin open source, since Oracle changed the license, the API template for most of the k-v btree stores around. Now supports replication | 
...
| (A standardized corpus for SQLite database forensics)[(https://www.sciencedirect.com/science/article/pii/S1742287618300471) | current | Sample SQLite databases and evaluations of 5 tools that do extraction and recovery from SQLite, including Undark and  |
